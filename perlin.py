...
def create_perlin_noise(seed=None, color=True, batch_size=11, image_size = 224 , normalize=True, precalc_fade=None):
    """
...
if __name__ == '__main__':
    a = create_perlin_noise(seed=None, color=True, batch_size=11,image_size=224, normalize=True, precalc_fade=None)
    b =1